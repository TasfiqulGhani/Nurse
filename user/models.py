...
class Customer(AbstractBaseUser):
    ...
    is_active = models.BooleanField(default=True)
    is_staff = models.BooleanField(default=False)
    is_living_alone = models.BooleanField(default=False)
    health_care_id = models.CharField(max_length=10, default='')
    is_superuser = models.BooleanField(default=False)
    password = models.CharField(max_length=20, default='123456')
    dob = models.DateField(null=True, blank=True)
    address = models.CharField(max_length=500, default='')
    accomodation_type = models.CharField(max_length=500, default='')
    access_to_home = models.CharField(max_length=500, default='')
    code = models.CharField(max_length=10, default='')
    accomodation_info = models.CharField(max_length=500, default='')
    ...
    private_notes = models.CharField(max_length=500, default='')
    fb_token = models.CharField(max_length=10, default='')
    fire_token = models.CharField(max_length=10, default='')
    date_joined = models.DateTimeField(default=timezone.now)
    last_updated = models.DateTimeField(default=timezone.now)
